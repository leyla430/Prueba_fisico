...
TRAJECTORY_BUILDER_2D.max_range = 8.0  -- 12.0

TRAJECTORY_BUILDER_2D.missing_data_ray_length = 6.0 --3.0                   
TRAJECTORY_BUILDER_2D.use_imu_data = false  -- dont use imu        
